...
class HighRoller extends \Nette\Application\UI\Control
{
  ...
  function __construct($type =NULL){
    ...
    $this->plotOptions = new HighRollerPlotOptions($type);
 ...
 public static function setHighChartsThemeLocation($location){
	return $scriptTag = "<!-- High Roller - High Charts Theme Location--><script type='text/javascript' src='" . $location . "'></script>";
  }
...
//  function renderChart($engine = 'jquery'){
  function render($engine = 'jquery'){
	...
	echo Html::el("script")->setText(trim($chartJS));
  }
